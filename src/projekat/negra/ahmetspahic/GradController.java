...
public class GradController {
    ...
    public void initialize() {
        ...
        //garant ne valjaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
        lvLetovi.setItems(listGradovi);
        if (grad != null) {
    ...
    public void clickDodaj(ActionEvent actionEvent) {
        listGradovi.add(choiceGrad.getSelectionModel().getSelectedItem());
        lvLetovi.setItems((FXCollections.observableArrayList(listGradovi)));
    }
}
